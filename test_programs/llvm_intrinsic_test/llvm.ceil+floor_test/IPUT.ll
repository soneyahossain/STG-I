...
@9 = private unnamed_addr constant [14 x i8] c"llvm.ceil.f64\00", align 1
...
@28 = private unnamed_addr constant [15 x i8] c"_ZL5floorf_RET\00", align 1
...
@59 = private unnamed_addr constant [15 x i8] c"tmp__ZL5floorf\00", align 1
@60 = private unnamed_addr constant [15 x i8] c"tmp__ZL5floorf\00", align 1
@61 = private unnamed_addr constant [16 x i8] c"tmp__ZL5floorf1\00", align 1
@62 = private unnamed_addr constant [15 x i8] c"llvm.floor.f32\00", align 1
@63 = private unnamed_addr constant [6 x i8] c"float\00", align 1
@64 = private unnamed_addr constant [15 x i8] c"tmp__ZL5floorf\00", align 1
@65 = private unnamed_addr constant [15 x i8] c"_ZL5floorf_RET\00", align 1
@66 = private unnamed_addr constant [16 x i8] c"tmp__ZL5floorf1\00", align 1
@67 = private unnamed_addr constant [6 x i8] c"entry\00", align 1
@68 = private unnamed_addr constant [8 x i8] c"(i32 0)\00", align 1
@69 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@70 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@71 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@72 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@73 = private unnamed_addr constant [6 x i8] c"arg_1\00", align 1
@74 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@75 = private unnamed_addr constant [6 x i8] c"arg_2\00", align 1
@76 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@77 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
@78 = private unnamed_addr constant [24 x i8] c"_Z13isGreaterThandf_RET\00", align 1
@79 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@80 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
@81 = private unnamed_addr constant [5 x i8] c"zext\00", align 1
@82 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
@83 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@84 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@85 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@86 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@87 = private unnamed_addr constant [12 x i8] c"tobool_main\00", align 1
@88 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@89 = private unnamed_addr constant [6 x i8] c"trunc\00", align 1
@90 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@91 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
@92 = private unnamed_addr constant [9 x i8] c"main_RET\00", align 1
@93 = private unnamed_addr constant [2 x i8] c"0\00", align 1
...
entry:
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @8, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @11, i32 0, i32 0))
  %tmp__Z13isGreaterThandf1 = call double @llvm.ceil.f64(double %tmp__Z13isGreaterThandf)
  ...
  %call__Z13isGreaterThandf = call float @_ZL5floorf(float %tmp__Z13isGreaterThandf3) #4
...
entry:
  ...
  %__lcpp_x.addr__ZL5floorf = alloca float, align 4
  store float %__lcpp_x, float* %__lcpp_x.addr__ZL5floorf, align 4
  call void @stg_update_store_float(float* %__lcpp_x.addr__ZL5floorf, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @58, i32 0, i32 0))
  %tmp__ZL5floorf = load float, float* %__lcpp_x.addr__ZL5floorf, align 4
  call void @stg_update_load_float(float* %__lcpp_x.addr__ZL5floorf, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @60, i32 0, i32 0))
  ...
  %tmp__ZL5floorf1 = call float @llvm.floor.f32(float %tmp__ZL5floorf)
...
entry:
  ...
  %call_main = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double* %x_main)
  call void @stg_update_input_double(double* %x_main)
  %call1_main = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1, i32 0, i32 0), float* %y_main)
  call void @stg_update_input_float(float* %y_main)
  call void @stg_begin_test()
  call void @stg_symbolic_variable_double(double* %x_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  call void @stg_symbolic_variable_float(float* %y_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.3, i32 0, i32 0))
  %tmp_main = load double, double* %x_main, align 8
  call void @stg_update_load_double(double* %x_main, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @70, i32 0, i32 0))
  %tmp_main1 = load float, float* %y_main, align 4
  call void @stg_update_load_float(float* %y_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @72, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @73, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @74, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @75, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @76, i32 0, i32 0))
  %call2_main = call zeroext i1 @_Z13isGreaterThandf(double %tmp_main, float %tmp_main1)
  call void @stg_update_char(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @77, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @78, i32 0, i32 0))
  ...
  call void @stg_update_store_i8(i8* %result_main, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @84, i32 0, i32 0))
  call void @stg_end_test()
  %tmp_main2 = load i8, i8* %result_main, align 1
  call void @stg_update_load_i8(i8* %result_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @86, i32 0, i32 0))
  %tobool_main = trunc i8 %tmp_main2 to i1
  call void @stg_update_cast_i8(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @87, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @88, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @89, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @90, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @91, i32 0, i32 0), i8 %tmp_main2)
  call void @stg_record_test(i1 zeroext %tobool_main)
  call void @stg_update_char(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @92, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @93, i32 0, i32 0))
  call void @stg_update_prev_bb(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @94, i32 0, i32 0))
  ret i32 0
}
