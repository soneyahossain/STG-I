...
@.str.2 = private unnamed_addr constant [3 x i8] c"S0\00", align 1
...
@9 = private unnamed_addr constant [24 x i8] c"tmp__Z13isGreaterThandf\00", align 1
@10 = private unnamed_addr constant [13 x i8] c"llvm.log.f64\00", align 1
...
@62 = private unnamed_addr constant [15 x i8] c"tmp__ZL5log10f\00", align 1
@63 = private unnamed_addr constant [15 x i8] c"llvm.log10.f32\00", align 1
@64 = private unnamed_addr constant [6 x i8] c"float\00", align 1
...
@79 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
...
@82 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
...
entry:
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @8, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @11, i32 0, i32 0))
...
entry:
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @61, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @62, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @63, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @64, i32 0, i32 0))
...
entry:
  ...
  call void @stg_symbolic_variable_double(double* %x_main, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0))
  call void @stg_symbolic_variable_float(float* %y_main, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
  ...
  call void @stg_update_char(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @79, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @80, i32 0, i32 0))
