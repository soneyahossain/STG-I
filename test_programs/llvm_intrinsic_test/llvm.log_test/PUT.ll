...
entry:
  ...
  %call = call float @_ZL5log10f(float %3) #4
...
entry:
  ...
  store float 0x4016666660000000, float* %y, align 4
  ...
  call void @stg_symbolic_variable_double(double* %x, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.2, i32 0, i32 0))
  call void @stg_symbolic_variable_float(float* %y, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.3, i32 0, i32 0))
