...
@9 = private unnamed_addr constant [35 x i8] c"tmp__Z24isIsoscelesRightTriangledd\00", align 1
@10 = private unnamed_addr constant [13 x i8] c"llvm.sin.f64\00", align 1
@11 = private unnamed_addr constant [7 x i8] c"double\00", align 1
...
@15 = private unnamed_addr constant [36 x i8] c"tmp__Z24isIsoscelesRightTriangledd2\00", align 1
@16 = private unnamed_addr constant [14 x i8] c"llvm.sqrt.f64\00", align 1
@17 = private unnamed_addr constant [7 x i8] c"double\00", align 1
...
@26 = private unnamed_addr constant [36 x i8] c"tmp__Z24isIsoscelesRightTriangledd4\00", align 1
@27 = private unnamed_addr constant [13 x i8] c"llvm.cos.f64\00", align 1
@28 = private unnamed_addr constant [7 x i8] c"double\00", align 1
...
@32 = private unnamed_addr constant [36 x i8] c"tmp__Z24isIsoscelesRightTriangledd6\00", align 1
@33 = private unnamed_addr constant [14 x i8] c"llvm.sqrt.f64\00", align 1
@34 = private unnamed_addr constant [7 x i8] c"double\00", align 1
...
@66 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@67 = private unnamed_addr constant [9 x i8] c"mul_main\00", align 1
@68 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@69 = private unnamed_addr constant [5 x i8] c"fmul\00", align 1
@70 = private unnamed_addr constant [18 x i8] c"(double 3.141593)\00", align 1
@71 = private unnamed_addr constant [9 x i8] c"div_main\00", align 1
@72 = private unnamed_addr constant [9 x i8] c"mul_main\00", align 1
@73 = private unnamed_addr constant [5 x i8] c"fdiv\00", align 1
@74 = private unnamed_addr constant [20 x i8] c"(double 180.000000)\00", align 1
@75 = private unnamed_addr constant [9 x i8] c"div_main\00", align 1
@76 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
...
@80 = private unnamed_addr constant [6 x i8] c"arg_1\00", align 1
@81 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@82 = private unnamed_addr constant [6 x i8] c"arg_2\00", align 1
@83 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@84 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
@85 = private unnamed_addr constant [35 x i8] c"_Z24isIsoscelesRightTriangledd_RET\00", align 1
@86 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@87 = private unnamed_addr constant [11 x i8] c"call2_main\00", align 1
@88 = private unnamed_addr constant [5 x i8] c"zext\00", align 1
@89 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
@90 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@91 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@92 = private unnamed_addr constant [10 x i8] c"tmp_main3\00", align 1
@93 = private unnamed_addr constant [10 x i8] c"tmp_main3\00", align 1
@94 = private unnamed_addr constant [12 x i8] c"tobool_main\00", align 1
...
@97 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@98 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
@99 = private unnamed_addr constant [9 x i8] c"main_RET\00", align 1
@100 = private unnamed_addr constant [2 x i8] c"0\00", align 1
@101 = private unnamed_addr constant [6 x i8] c"entry\00", align 1
...
entry:
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @8, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @11, i32 0, i32 0))
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @14, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @15, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @16, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @17, i32 0, i32 0))
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @25, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @26, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @27, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @28, i32 0, i32 0))
  ...
  call void @stg_update_una_intrinsic(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @31, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @32, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @33, i32 0, i32 0), i8* getelementptr inbounds ([7 x i8], [7 x i8]* @34, i32 0, i32 0))
...
entry:
  ...
  %call_main = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double* %theta_main)
  call void @stg_update_input_double(double* %theta_main)
  %call1_main = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double* %hyp_sqr_main)
  call void @stg_update_input_double(double* %hyp_sqr_main)
  call void @stg_begin_test()
  call void @stg_symbolic_variable_double(double* %theta_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  call void @stg_symbolic_variable_double(double* %hyp_sqr_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  %tmp_main = load double, double* %theta_main, align 8
  call void @stg_update_load_double(double* %theta_main, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @66, i32 0, i32 0))
  %mul_main = fmul double %tmp_main, 0x400921FB54442D18
  call void @stg_update_op(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @67, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @68, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @69, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @70, i32 0, i32 0))
  %div_main = fdiv double %mul_main, 1.800000e+02
  call void @stg_update_op(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @71, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @72, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @73, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @74, i32 0, i32 0))
  store double %div_main, double* %theta_main, align 8
  call void @stg_update_store_double(double* %theta_main, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @75, i32 0, i32 0))
  %tmp_main1 = load double, double* %theta_main, align 8
  call void @stg_update_load_double(double* %theta_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @77, i32 0, i32 0))
  %tmp_main2 = load double, double* %hyp_sqr_main, align 8
  call void @stg_update_load_double(double* %hyp_sqr_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @79, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @80, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @81, i32 0, i32 0))
  ...
  %call2_main = call zeroext i1 @_Z24isIsoscelesRightTriangledd(double %tmp_main1, double %tmp_main2)
  call void @stg_update_char(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @84, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @85, i32 0, i32 0))
  call void @stg_update_cast_i1(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @86, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @87, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @88, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @89, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @90, i32 0, i32 0), i1 %call2_main)
  %frombool_main = zext i1 %call2_main to i8
  store i8 %frombool_main, i8* %is_isosceles_main, align 1
  call void @stg_update_store_i8(i8* %is_isosceles_main, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @91, i32 0, i32 0))
  call void @stg_end_test()
  %tmp_main3 = load i8, i8* %is_isosceles_main, align 1
  call void @stg_update_load_i8(i8* %is_isosceles_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @93, i32 0, i32 0))
  %tobool_main = trunc i8 %tmp_main3 to i1
  call void @stg_update_cast_i8(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @94, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @95, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @96, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @97, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @98, i32 0, i32 0), i8 %tmp_main3)
  call void @stg_record_test(i1 zeroext %tobool_main)
  call void @stg_update_char(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @99, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @100, i32 0, i32 0))
  call void @stg_update_prev_bb(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @101, i32 0, i32 0))
  ret i32 0
}
