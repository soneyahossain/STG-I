...
entry:
  ...
  %call = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double* %theta)
  %call1 = call i32 (i8*, ...) @scanf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), double* %hyp_sqr)
  call void @stg_begin_test()
  call void @stg_symbolic_variable_double(double* %theta, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  call void @stg_symbolic_variable_double(double* %hyp_sqr, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.2, i32 0, i32 0))
  ...
  %call2 = call zeroext i1 @_Z24isIsoscelesRightTriangledd(double %1, double %2)
