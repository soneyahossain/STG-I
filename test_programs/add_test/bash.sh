...
clang++ -std=c++14 -emit-llvm -fno-discard-value-names add.cpp -c -o PUT.bc
...
opt -load=/Users/soneyabintahossain/llvm_project/llvm-project/build/lib/LLVMSTGInstrumenter.dylib -STGInstrumenter PUT.bc -o IPUT.bc
...
clang++ -std=c++14 -emit-llvm stg.cpp -c -o symbolicstate.bc


# Step 4:
# link symtem under test and stg library together
llvm-link IPUT.bc symbolicstate.bc -o linked.bc
...
clang++ -o a.out  linked.ocommandLine.sh
