...
@prev_bb = global i8* getelementptr inbounds ([6 x i8], [6 x i8]* @49, i32 0, i32 0), align 4
...
@5 = private unnamed_addr constant [18 x i8] c"tmp__Z8find_maxii\00", align 1
@6 = private unnamed_addr constant [18 x i8] c"tmp__Z8find_maxii\00", align 1
@7 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii1\00", align 1
@8 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii1\00", align 1
@9 = private unnamed_addr constant [4 x i8] c"cmp\00", align 1
@10 = private unnamed_addr constant [18 x i8] c"tmp__Z8find_maxii\00", align 1
@11 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii1\00", align 1
@12 = private unnamed_addr constant [4 x i8] c"sgt\00", align 1
@13 = private unnamed_addr constant [4 x i8] c"i32\00", align 1
@14 = private unnamed_addr constant [4 x i8] c"cmp\00", align 1
@15 = private unnamed_addr constant [6 x i8] c"entry\00", align 1
@16 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii2\00", align 1
...
@20 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii3\00", align 1
...
@23 = private unnamed_addr constant [8 x i8] c"if.else\00", align 1
...
@26 = private unnamed_addr constant [18 x i8] c"_Z8find_maxii_RET\00", align 1
@27 = private unnamed_addr constant [19 x i8] c"tmp__Z8find_maxii4\00", align 1
@28 = private unnamed_addr constant [7 x i8] c"return\00", align 1
@29 = private unnamed_addr constant [7 x i8] c"retval\00", align 1
@30 = private unnamed_addr constant [2 x i8] c"a\00", align 1
...
@34 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@35 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@36 = private unnamed_addr constant [10 x i8] c"tmp_main3\00", align 1
@37 = private unnamed_addr constant [10 x i8] c"tmp_main4\00", align 1
@38 = private unnamed_addr constant [10 x i8] c"tmp_main4\00", align 1
@39 = private unnamed_addr constant [10 x i8] c"tmp_main5\00", align 1
@40 = private unnamed_addr constant [10 x i8] c"tmp_main5\00", align 1
...
@44 = private unnamed_addr constant [10 x i8] c"tmp_main5\00", align 1
@45 = private unnamed_addr constant [5 x i8] c"call\00", align 1
@46 = private unnamed_addr constant [18 x i8] c"_Z8find_maxii_RET\00", align 1
@47 = private unnamed_addr constant [9 x i8] c"main_RET\00", align 1
...
entry:
  ...
  call void @stg_update_load(i32* %a.addr, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @6, i32 0, i32 0))
  %tmp__Z8find_maxii1 = load i32, i32* %b.addr, align 4
  call void @stg_update_load(i32* %b.addr, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @8, i32 0, i32 0))
  %cmp = icmp sgt i32 %tmp__Z8find_maxii, %tmp__Z8find_maxii1
  call void @stg_update_cmp(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @9, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @10, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @12, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @11, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @13, i32 0, i32 0))
  call void @stg_update_pc(i1 %cmp, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @14, i32 0, i32 0))
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %tmp__Z8find_maxii2 = load i32, i32* %a.addr, align 4
  call void @stg_update_load(i32* %a.addr, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @17, i32 0, i32 0))
  store i32 %tmp__Z8find_maxii2, i32* %retval, align 4
  call void @stg_update_store(i32* %retval, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @18, i32 0, i32 0))
  br label %return

if.else:                                          ; preds = %entry
  %tmp__Z8find_maxii3 = load i32, i32* %b.addr, align 4
  call void @stg_update_load(i32* %b.addr, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @21, i32 0, i32 0))
  store i32 %tmp__Z8find_maxii3, i32* %retval, align 4
  call void @stg_update_store(i32* %retval, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @22, i32 0, i32 0))
  br label %return

return:                                           ; preds = %if.else, %if.then
  %tmp__Z8find_maxii4 = load i32, i32* %retval, align 4
  call void @stg_update_load(i32* %retval, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @25, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @26, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @27, i32 0, i32 0))
...
entry:
  ...
  call void @stg_update_store(i32* %retval, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @32, i32 0, i32 0))
  ...
  call void @stg_update_load(i32* %a, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @38, i32 0, i32 0))
  %tmp_main5 = load i32, i32* %b, align 4
  call void @stg_update_load(i32* %b, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @40, i32 0, i32 0))
  ...
  call void @stg_update_char(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @43, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @44, i32 0, i32 0))
  %call = call i32 @_Z8find_maxii(i32 %tmp_main4, i32 %tmp_main5)
  call void @stg_update_char(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @45, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @46, i32 0, i32 0))
  call void @stg_assert(i1 zeroext true)
  call void @stg_end_test()
  call void @stg_update_char(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @47, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @48, i32 0, i32 0))
  ret i32 0
}
