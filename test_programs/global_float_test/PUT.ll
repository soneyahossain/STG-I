...
entry:
  ...
  %istall = alloca i8, align 1
  store i32 0, i32* %retval, align 4
  store float 0x401A666660000000, float* %height, align 4
  call void @stg_begin_test()
  call void @stg_symbolic_variable_float(float* %height, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  %0 = load float, float* %height, align 4
  %call = call zeroext i1 @_Z6isTallf(float %0)
  %frombool = zext i1 %call to i8
  store i8 %frombool, i8* %istall, align 1
  call void @stg_end_test()
  %1 = load i8, i8* %istall, align 1
