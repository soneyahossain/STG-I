...
clang -emit-llvm -fno-discard-value-names  test1.c -c -o PUT.bc
...
/Users/soneyabintahossain/llvm_project/llvm-project/build/bin/llvm-dis symbolicstate.bc -o symbolicstate.ll
