...
clang++ -std=c++14 -O0 -emit-llvm -fno-discard-value-names classify.cpp -c -o PUT.bc
clang++ -std=c++14 -O1 -emit-llvm -fno-discard-value-names classify.cpp -c -o PUT1.bc
clang++ -std=c++14 -O2 -emit-llvm -fno-discard-value-names classify.cpp -c -o PUT2.bc
#clang++ -std=c++14 -O3 -emit-llvm -fno-discard-value-names classify.cpp -c -o PUT3.bc

#clang++ -std=c++14 -Oz -emit-llvm -fno-discard-value-names classify.cpp -c -o PUTz.bc
