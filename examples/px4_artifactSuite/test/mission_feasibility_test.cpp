...
TEST(MissionCheck, CheckCombined)
{
    ...
    //step1: call stg_start_instrument

    stg_start_instrument();

    //step2: declare all the variables and assign values
    ...
    //step 4: declare all symbolic variables
    ...
    //step 5: call stg_stop_instrument
    stg_stop_instrument();
    //step 6: end test
    stg_end_test();
...
TEST(CheckWayPoints, AltitudeBreaker)
{
...
TEST(CheckAltitude, InvalidMission2PointsBelowHome)
{
    ...
    // Sample test with a mission with second waypoint invalid altitude below home
    stg_start_instrument();
