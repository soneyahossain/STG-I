...
entry:
  ...
  store double 3.000000e+00, double* %base, align 8
  store double 4.000000e+00, double* %power, align 8
  call void @stg_begin_test()
  call void @stg_symbolic_variable_double(double* %base, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  call void @stg_symbolic_variable_double(double* %power, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %0 = load double, double* %base, align 8
  %1 = load double, double* %power, align 8
  %call = call zeroext i1 @_Z13isGreaterThandd(double %0, double %1)
