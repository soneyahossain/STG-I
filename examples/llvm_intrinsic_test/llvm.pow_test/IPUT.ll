...
@100 = private unnamed_addr constant [18 x i8] c"(double 3.000000)\00", align 1
@101 = private unnamed_addr constant [18 x i8] c"(double 4.000000)\00", align 1
@102 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@103 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@104 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@105 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@106 = private unnamed_addr constant [6 x i8] c"arg_1\00", align 1
@107 = private unnamed_addr constant [9 x i8] c"tmp_main\00", align 1
@108 = private unnamed_addr constant [6 x i8] c"arg_2\00", align 1
@109 = private unnamed_addr constant [10 x i8] c"tmp_main1\00", align 1
@110 = private unnamed_addr constant [10 x i8] c"call_main\00", align 1
@111 = private unnamed_addr constant [24 x i8] c"_Z13isGreaterThandd_RET\00", align 1
@112 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@113 = private unnamed_addr constant [10 x i8] c"call_main\00", align 1
@114 = private unnamed_addr constant [5 x i8] c"zext\00", align 1
@115 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
@116 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@117 = private unnamed_addr constant [14 x i8] c"frombool_main\00", align 1
@118 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@119 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@120 = private unnamed_addr constant [12 x i8] c"tobool_main\00", align 1
@121 = private unnamed_addr constant [10 x i8] c"tmp_main2\00", align 1
@122 = private unnamed_addr constant [6 x i8] c"trunc\00", align 1
@123 = private unnamed_addr constant [3 x i8] c"i8\00", align 1
@124 = private unnamed_addr constant [3 x i8] c"i1\00", align 1
...
entry:
  ...
  store double 3.000000e+00, double* %base_main, align 8
  call void @stg_update_store_double(double* %base_main, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @100, i32 0, i32 0))
  store double 4.000000e+00, double* %power_main, align 8
  call void @stg_update_store_double(double* %power_main, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @101, i32 0, i32 0))
  call void @stg_begin_test()
  call void @stg_symbolic_variable_double(double* %base_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i32 0, i32 0))
  call void @stg_symbolic_variable_double(double* %power_main, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.1, i32 0, i32 0))
  %tmp_main = load double, double* %base_main, align 8
  call void @stg_update_load_double(double* %base_main, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @103, i32 0, i32 0))
  %tmp_main1 = load double, double* %power_main, align 8
  call void @stg_update_load_double(double* %power_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @105, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @106, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @107, i32 0, i32 0))
  call void @stg_update_char(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @108, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @109, i32 0, i32 0))
  %call_main = call zeroext i1 @_Z13isGreaterThandd(double %tmp_main, double %tmp_main1)
  call void @stg_update_char(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @110, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @111, i32 0, i32 0))
  call void @stg_update_cast_i1(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @112, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @113, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @114, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @115, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @116, i32 0, i32 0), i1 %call_main)
  %frombool_main = zext i1 %call_main to i8
  store i8 %frombool_main, i8* %result_main, align 1
  call void @stg_update_store_i8(i8* %result_main, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @117, i32 0, i32 0))
  call void @stg_end_test()
  %tmp_main2 = load i8, i8* %result_main, align 1
  call void @stg_update_load_i8(i8* %result_main, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @119, i32 0, i32 0))
  %tobool_main = trunc i8 %tmp_main2 to i1
  call void @stg_update_cast_i8(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @120, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @121, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @122, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @123, i32 0, i32 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @124, i32 0, i32 0), i8 %tmp_main2)
  ...
  call void @stg_update_prev_bb(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @127, i32 0, i32 0))
  ret i32 0
}
